...
class DataApi:
    ...
    async def get_stock_list_in_sector(self, sector_name: str, sector_type: str | None = None) -> SectorResponse:
        payload = await self._transport.request(
            "POST",
            "/api/v1/data/sector",
    ...
    async def get_index_weight(self, index_code: str, *, date: str | None = None) -> IndexWeightResponse:
        payload = await self._transport.request(
            "POST",
    ...
    async def get_convertible_bonds(self) -> list[ConvertibleBondInfo]:
        payload = await self._transport.request("GET", "/api/v1/data/convertible-bonds")
    ...
    async def get_full_tick(self, *, stock_codes: list[str], start_time: str = "", end_time: str = "") -> Any:
        return await self._transport.request(
            "POST",
            "/api/v1/data/full-tick",
            json={"stock_codes": stock_codes, "start_time": start_time, "end_time": end_time},
        )

    async def get_divid_factors(self, *, stock_code: str) -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def download_sector_data(self) -> Any:
        return await self._transport.request("POST", "/api/v1/data/download/sector-data")

    async def download_index_weight(self, *, index_code: str | None = None) -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def download_cb_data(self) -> Any:
        return await self._transport.request("POST", "/api/v1/data/download/cb-data")

    async def download_etf_info(self) -> Any:
        return await self._transport.request("POST", "/api/v1/data/download/etf-info")

    async def download_holiday_data(self) -> Any:
        return await self._transport.request("POST", "/api/v1/data/download/holiday-data")

    async def download_history_contracts(self, *, market: str | None = None) -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def create_sector_folder(self, *, parent_node: str = "", folder_name: str = "") -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def create_sector(self, *, sector_name: str, parent_node: str = "", overwrite: bool = True) -> Any:
        return await self._transport.request(
            "POST",
            "/api/v1/data/sector/create",
            json={"parent_node": parent_node, "sector_name": sector_name, "overwrite": overwrite},
        )

    async def add_sector_stocks(self, *, sector_name: str, stock_list: list[str]) -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def remove_sector_stocks(self, *, sector_name: str, stock_list: list[str]) -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def remove_sector(self, *, sector_name: str) -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def reset_sector(self, *, sector_name: str, stock_list: list[str]) -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def get_l2_quote(self, *, stock_codes: list[str], start_time: str = "", end_time: str = "") -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def get_l2_order(self, *, stock_codes: list[str], start_time: str = "", end_time: str = "") -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def get_l2_transaction(self, *, stock_codes: list[str], start_time: str = "", end_time: str = "") -> Any:
        return await self._transport.request(
            "POST",
    ...
    async def delete_subscription(self, *, subscription_id: str) -> SubscriptionDeleteResult:
        payload = await self._transport.request("DELETE", f"/api/v1/data/subscription/{subscription_id}")
    ...
    async def get_subscription(self, *, subscription_id: str) -> SubscriptionInfo:
        payload = await self._transport.request("GET", f"/api/v1/data/subscription/{subscription_id}")
        return SubscriptionInfo.model_validate(payload)

    async def list_subscriptions(self) -> SubscriptionListResult:
        payload = await self._transport.request("GET", "/api/v1/data/subscriptions")
